...
export default function Step2Code() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#000", justifyContent: "center", padding: 24 }}>
      ...
      >
        {/* Titulo */}
        <Text style={{ color: "#0f0f0fff", fontWeight: "700", fontSize: 18, marginBottom: 10, alignSelf: "center" }}>
          RECUPERAR CONTRASEÑA
        </Text>
        <Text style={{ color: "#080808ff", marginBottom: 10 }}>
          Ingrese el código enviado al número asociado al DNI {dni}
        </Text>
