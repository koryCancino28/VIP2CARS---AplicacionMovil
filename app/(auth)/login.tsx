...
export default function LoginScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#000", padding: 24, justifyContent: "center" }}>
      ...
      >
        <Text style={{ color: "#000000ff", fontSize: 20, fontWeight: "600", alignSelf: "center", marginBottom: 15 }}>
          INICIO DE SESIÓN
        </Text>
        ...
        <TextInput
          style={{ backgroundColor: "#ecececff", color: "#000000ff", borderRadius: 8, padding: 12, marginBottom: 12 }}
          value={dni}
          onChangeText={setDni}
